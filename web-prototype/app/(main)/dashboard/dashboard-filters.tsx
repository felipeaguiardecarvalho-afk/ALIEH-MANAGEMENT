  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Período, clientes activos (janela), envelhecimento de stock, SKU, produto e cliente —{" "}
          <code className="rounded bg-muted px-1">GET /dashboard/panel</code>.
        </CardDescription>
      </CardHeader>
        ...
        <form method="get" action="/dashboard" className="grid gap-4 md:grid-cols-2 lg:grid-cols-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-[11px] leading-snug text-muted-foreground">
              Janela móvel até à data final: vendas distintas por cliente.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-[11px] leading-snug text-muted-foreground">
              Tabela «Inventário envelhecido» (15–180).
            </p>
          </div>
